        ...
        <div class="site-footer__top">
            <div class="container">
                <div class="site-footer__top-inner">
                    <div class="site-footer-map" style="background-image: url({{ asset('siteasset/images/shapes/site-footer-mape.png')}})"></div>
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__about-logo">
                                    <a href="index.html"><img src={{ asset('siteasset/images/resources/footer-logo.png')}} alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="footer-widget__column footer-widget__contact">
                                ...
                                <p class="footer-widget__contact-text">{{ __('message.address') }}</p>
                                <ul class="list-unstyled footer-widget__contact-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p><a href="tel:+8801739979350">Free:+(880) 1739979350</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="site-footer__bottom-inner">
                                <div class="site-footer__bottom-left">
                                    <p class="site-footer__bottom-text">© All Copyright <span class="dynamic-year">
                                        </span><!-- /.dynamic-year --> by <a href="http://shibli.intels.co/">Syscon Solution Ltd.</a></p>
                                </div>
