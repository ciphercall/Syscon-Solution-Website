...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">তরিক্বত পন্থী তালিকা</h3>
                <ul class="breadcrumb">
    ...
    <div class="row filter-row">
        <div class="col-sm-6 col-md-3">
            <div class="form-group form-focus">
                ...
                <label class="focus-label">তরিক্বত পন্থী তালিকা ID</label>
            </div>
        </div>
        <div class="col-sm-6 col-md-3">
            <div class="form-group form-focus">
                <input type="text" class="form-control floating">
                <label class="focus-label">তরিক্বত পন্থী তালিকা Name</label>
            </div>
        </div>
        <div class="col-sm-6 col-md-3">
                ...
                <table  id="example" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>তরিক্বত গ্রহণের তারিখ</th>

                            <th>শেষ ছবক</th>

                            <th>বাইয়াত গ্রহণের তারিখ</th>
                            <th>Status</th>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
								...
								<button type="button" value="{{$member->id}}" class="btn btn-warning" id="editmember" ><i class="bi bi-pencil-square"></i>  </button>
                                  ...
                                  <button type="button" value="{{$member->id}}" class="btn btn-primary" id="deletebtn" ><i class="fa fa-trash-o m-r-5"></i> </button>
                            </td>
                        </tr>
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="form-header">
							<h3>তরিক্বত পন্থী বাতিল করুন</h3>
	...
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"> তরিক্বত পন্থী সংযোজন</h5>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="txtFather" name="txtFather" placeholder="জন্ম তারিখ " required>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="number" class="form-control" id="txtFamily_member" name="txtFamily_member" placeholder="তরিক্বপন্থী সদস্য" required>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-form-label"> রক্তের গ্রুপ:<span class="text-danger">*</span></label>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="txtBrunch_name" name="txtBrunch_name" required placeholder="শাখার নাম">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
