...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">কেন্দ্রীয় সদস্যের  তালিকা</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                    <li class="breadcrumb-item active">কেন্দ্রীয় কেন্দ্রীয় সদস্য</li>
                </ul>
            </div>
            <div class="col-auto float-right ml-auto">
                <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i>   সদস্য সংযোজন</a>
                <div class="view-icons">
                    <a href="{{url('/centralmembers')}}" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table id="example" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @foreach ($cmembers as $key=> $member)
                        <tr>
                            <th scope="row">{{ ++$key }}</th>
                            <td>
                                <h2 class="table-avatar">
                                    <a href="{{route('members.show',$member->id)}}" class="avatar"><img src="{{asset('img')}}/{{$member->m_photo}}" /></a>
                                    <a href="{{route('members.show',$member->id)}}">{{$member->m_name}} <span>{{$member->occupation}}</span></a>
                                </h2>
                            </td>
                            ...
                            <td class="text-right">
								...
								<a href="{{route('centralmembers.show',$member->id)}}"><button type="button" value="{{$member->id}}" class="btn btn-success" id="padcshBtn" ><i class="bi bi-eye-fill"></i> </button></a>

						<button type="button" value="{{$member->id}}" class="btn btn-primary" id="cmemBtn" ><i class="bi bi-pencil-square" ></i> </button>

						<button type="button" value="{{$member->id}}" class="btn btn-warning" id="cmemDbtn" ><i class="fa fa-trash-o m-r-5"></i> </button>
	...
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"> কেন্দ্রীয় সদস্য সংযোজন</h5>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<select id="ctxtDesignation" class="form-control" name="txtDesignation" required>
									<option selected>Choose...</option>
        ...
        $("#txtName").on("change",function(){
           $.ajax({
            ...
            //    $("#txtCity").val(member.city);
               ...
               $("#ooBrunch_name").val(member.brunch_name);
               $("#txtBaiyat_date").val(member.baiyat_date);
               $("#txtOccasion").val(member.occasion);
               $("#txtDuty").val(member.duty);
               $("#ctxtDesignation").val(member.designation);
               $("#cSHi_photo").html(


                        `<img src='{{asset("img/`+member.m_photo+`")}}' width="100" class="img-fluid img-thumbnail">`);
            //    $("#").val(member.);
