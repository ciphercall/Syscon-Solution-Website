...
<div class="content container-fluid">
	...
	<div class="page-header">
		<div class="row">
			<div class="col-sm-12">
				<h3 class="page-title">মেহমানের বিস্তারিত তথ্য</h3>
				<ul class="breadcrumb">
							...
							<div class="row">
								<div class="col-md-5">
									<div class="profile-info-left">
										...
										<div class="staff-id">মেহমান নং : FT-{{$member->id}}</div>
                                        <div class="staff-id">ব্রান্স নং : {{$member->brunch_id}}</div>
										<div class="small doj text-muted">বাইয়াত গ্রহণের তারিখ : {{$member->baiyat_date}}</div>
		...
		<div id="emp_profile" class="pro-overview tab-pane fade show active">
			...
			<div class="row">
				<div class="col-md-6 d-flex">
					<div class="card profile-box flex-fill">
						<div class="card-body">
							<h3 class="card-title">তরিক্বত গ্রহণের তথ্য</h3>
							<ul class="personal-info">
								<li>
                                ...
                                <li>
									<div class="title">মাধ্যমে এসেছে</div>
									<div class="text">{{$member->donation_box_id}}</div>
								</li>
