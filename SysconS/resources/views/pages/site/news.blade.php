    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="100ms">
                ...
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="{{ URL::to('/siteasset/images/blog/news-page-img-1.jpg')}}" alt="">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="{{ URL::to('/siteasset/images/blog/news-page-img-2.jpg')}}" alt="">
                        <a href="news-details.html">
                            <span class="news-one__plus"></span>
                        </a>
                        <div class="news-one__date-box">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInRight" data-wow-delay="300ms">
                ...
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="{{ URL::to('/siteasset/images/blog/news-page-img-3.jpg')}}" alt="">
                        <a href="news-details.html">
                            <span class="news-one__plus"></span>
                        </a>
                        <div class="news-one__date-box">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="400ms">
                ...
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="{{ URL::to('/siteasset/assets/images/blog/news-page-img-4.jpg')}}" alt="">
                        <a href="news-details.html">
                            <span class="news-one__plus"></span>
                        </a>
                        <div class="news-one__date-box">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="500ms">
                ...
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="{{ URL::to('/siteasset/images/blog/news-page-img-5.jpg')}}" alt="">
                        <a href="news-details.html">
                            <span class="news-one__plus"></span>
                        </a>
                        <div class="news-one__date-box">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInRight" data-wow-delay="600ms">
                ...
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="{{ URL::to('/siteasset/images/blog/news-page-img-6.jpg')}}" alt="">
                        <a href="news-details.html">
                            <span class="news-one__plus"></span>
                        </a>
                        <div class="news-one__date-box">
